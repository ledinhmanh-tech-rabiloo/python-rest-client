...
from tb_rest_client_v4.models.models_ce import EntityVersion, SingleEntityVersionCreateRequest, \
...
from tb_rest_client_v4 import RestClientCE
...
def update_device(device: Device, rest_client: RestClientCE) -> tuple[Device, int]:
    ...
    with RestClientCE(base_url=url) as rest_client:
        try:
            ...
            for _ in range(create_new_versions_count):
                ...
                device_version_create_request_config = VersionCreateConfig(True, True, True)
            ...
            device_version_load_request_config = VersionLoadConfig(True, True, True)
