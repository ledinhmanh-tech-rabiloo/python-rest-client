...
class SolutionControllerApi(object):
    ...
    def uninstall_solution_template_using_delete(self, solution_template_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.uninstall_solution_template_using_delete(solution_template_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.uninstall_solution_template_using_delete_with_http_info(solution_template_id, **kwargs)  # noqa: E501
        else:
            (data) = self.uninstall_solution_template_using_delete_with_http_info(solution_template_id, **kwargs)  # noqa: E501
            return data

    def uninstall_solution_template_using_delete_with_http_info(self, solution_template_id, **kwargs):  # noqa: E501
        """Uninstall Solution Template (uninstallSolutionTemplate)  # noqa: E501

        Uninstall solution template based on the provided id   Security check is performed to verify that the user has 'DELETE' permission for the entity (entities).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.uninstall_solution_template_using_delete_with_http_info(solution_template_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method uninstall_solution_template_using_delete" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'solution_template_id' is set
        if ('solution_template_id' not in params or
                params['solution_template_id'] is None):
            raise ValueError("Missing the required parameter `solution_template_id` when calling `uninstall_solution_template_using_delete`")  # noqa: E501
