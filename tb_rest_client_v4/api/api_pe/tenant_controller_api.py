...
class TenantControllerApi(object):
    ...
    def get_tenant_infos_using_get(self, page_size, page, **kwargs):  # noqa: E501
        ...
        :param str text_search: The case insensitive 'startsWith' filter based on the tenant name.
    ...
    def get_tenant_infos_using_get_with_http_info(self, page_size, page, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/tenantInfos{?page,pageSize,sortOrder,sortProperty,textSearch}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_tenants_by_ids_using_get(self, tenant_ids, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_tenants_by_ids_using_get_with_http_info(tenant_ids, **kwargs)  # noqa: E501
        else:
            (data) = self.get_tenants_by_ids_using_get_with_http_info(tenant_ids, **kwargs)  # noqa: E501
            return data

    def get_tenants_by_ids_using_get_with_http_info(self, tenant_ids, **kwargs):  # noqa: E501
        """getTenantsByIds  # noqa: E501
        ...
        all_params = ['tenant_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('tenant_ids' not in params or
                params['tenant_ids'] is None):
            raise ValueError("Missing the required parameter `tenant_ids` when calling `get_tenants_by_ids_using_get`")  # noqa: E501
    ...
    def get_tenants_using_get_with_http_info(self, page_size, page, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/tenants{?page,pageSize,sortOrder,sortProperty,textSearch}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def save_tenant_using_post(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.save_tenant_using_post(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.save_tenant_using_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.save_tenant_using_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def save_tenant_using_post_with_http_info(self, **kwargs):  # noqa: E501
        """Create Or update Tenant (saveTenant)  # noqa: E501

        Create or update the Tenant. When creating tenant, platform generates Tenant Id as [time-based UUID](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_1_(date-time_and_MAC_address)). Default Rule Chain and Device profile are also generated for the new tenants automatically. The newly created Tenant Id will be present in the response. Specify existing Tenant Id id to update the Tenant. Referencing non-existing Tenant Id will cause 'Not Found' error.  Available for users with 'SYS_ADMIN' authority.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.save_tenant_using_post_with_http_info(async_req=True)
        >>> result = thread.get()
