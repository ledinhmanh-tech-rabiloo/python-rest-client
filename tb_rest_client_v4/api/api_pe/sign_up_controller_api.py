...
class SignUpControllerApi(object):
    ...
    def accept_privacy_policy_and_terms_of_use_using_post(self, **kwargs):  # noqa: E501
        """acceptPrivacyPolicyAndTermsOfUse  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.accept_privacy_policy_and_terms_of_use_using_post(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.accept_privacy_policy_and_terms_of_use_using_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.accept_privacy_policy_and_terms_of_use_using_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def accept_privacy_policy_and_terms_of_use_using_post_with_http_info(self, **kwargs):  # noqa: E501
        """acceptPrivacyPolicyAndTermsOfUse  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.accept_privacy_policy_and_terms_of_use_using_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method accept_privacy_policy_and_terms_of_use_using_post" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/signup/acceptPrivacyPolicyAndTermsOfUse', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def activate_cloud_email_using_get(self, email_code, **kwargs):  # noqa: E501
        """activateCloudEmail  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.activate_cloud_email_using_get(email_code, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.activate_cloud_email_using_get_with_http_info(email_code, **kwargs)  # noqa: E501
        else:
            (data) = self.activate_cloud_email_using_get_with_http_info(email_code, **kwargs)  # noqa: E501
            return data

    def activate_cloud_email_using_get_with_http_info(self, email_code, **kwargs):  # noqa: E501
        """activateCloudEmail  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.activate_cloud_email_using_get_with_http_info(email_code, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method activate_cloud_email_using_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('email_code' not in params or
            ...
            raise ValueError("Missing the required parameter `email_code` when calling `activate_cloud_email_using_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/noauth/cloud/activateEmail{?emailCode}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def activate_cloud_user_by_email_code_using_post(self, email_code, **kwargs):  # noqa: E501
        """activateCloudUserByEmailCode  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.activate_cloud_user_by_email_code_using_post(email_code, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.activate_cloud_user_by_email_code_using_post_with_http_info(email_code, **kwargs)  # noqa: E501
        else:
            (data) = self.activate_cloud_user_by_email_code_using_post_with_http_info(email_code, **kwargs)  # noqa: E501
            return data

    def activate_cloud_user_by_email_code_using_post_with_http_info(self, email_code, **kwargs):  # noqa: E501
        """activateCloudUserByEmailCode  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.activate_cloud_user_by_email_code_using_post_with_http_info(email_code, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method activate_cloud_user_by_email_code_using_post" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'email_code' is set
        if ('email_code' not in params or
                params['email_code'] is None):
            raise ValueError("Missing the required parameter `email_code` when calling `activate_cloud_user_by_email_code_using_post`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/noauth/cloud/activateByEmailCode{?emailCode}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_tenant_account_using_post(self, **kwargs):  # noqa: E501
        """deleteTenantAccount  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_tenant_account_using_post(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param DeleteTenantRequest body:
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_tenant_account_using_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.delete_tenant_account_using_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def delete_tenant_account_using_post_with_http_info(self, **kwargs):  # noqa: E501
        """deleteTenantAccount  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_tenant_account_using_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_tenant_account_using_post" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def resend_cloud_email_activation_using_post(self, email, **kwargs):  # noqa: E501
        """resendCloudEmailActivation  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.resend_cloud_email_activation_using_post(email, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.resend_cloud_email_activation_using_post_with_http_info(email, **kwargs)  # noqa: E501
        else:
            (data) = self.resend_cloud_email_activation_using_post_with_http_info(email, **kwargs)  # noqa: E501
            return data

    def resend_cloud_email_activation_using_post_with_http_info(self, email, **kwargs):  # noqa: E501
        """resendCloudEmailActivation  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.resend_cloud_email_activation_using_post_with_http_info(email, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method resend_cloud_email_activation_using_post" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('email' not in params or
            ...
            raise ValueError("Missing the required parameter `email` when calling `resend_cloud_email_activation_using_post`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/noauth/cloud/resendEmailActivation{?email}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
