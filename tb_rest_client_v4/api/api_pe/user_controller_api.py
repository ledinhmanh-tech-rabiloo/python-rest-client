...
class UserControllerApi(object):
    ...
    def save_user_using_post_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/user{?entityGroupId,sendActivationMail}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
