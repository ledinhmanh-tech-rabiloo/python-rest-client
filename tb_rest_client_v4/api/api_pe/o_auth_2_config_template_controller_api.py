...
class OAuth2ConfigTemplateControllerApi(object):
    ...
    def save_client_registration_template_using_post(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.save_client_registration_template_using_post(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.save_client_registration_template_using_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.save_client_registration_template_using_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def save_client_registration_template_using_post_with_http_info(self, **kwargs):  # noqa: E501
        """Create or update OAuth2 client registration template (saveClientRegistrationTemplate)  Available for users with 'SYS_ADMIN' authority.  # noqa: E501

        Client registration template is OAuth2 provider configuration template with default settings for registering new OAuth2 clients  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.save_client_registration_template_using_post_with_http_info(async_req=True)
        >>> result = thread.get()
