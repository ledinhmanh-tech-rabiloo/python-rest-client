...
class DeviceGroupOtaPackageControllerApi(object):
    ...
    def save_device_group_ota_package_using_post(self, **kwargs):  # noqa: E501
        """saveDeviceGroupOtaPackage  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.save_device_group_ota_package_using_post(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.save_device_group_ota_package_using_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.save_device_group_ota_package_using_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def save_device_group_ota_package_using_post_with_http_info(self, **kwargs):  # noqa: E501
        """saveDeviceGroupOtaPackage  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.save_device_group_ota_package_using_post_with_http_info(async_req=True)
        >>> result = thread.get()
