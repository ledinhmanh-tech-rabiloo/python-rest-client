...
class AlarmControllerApi(object):
    ...
    def get_alarms_using_get(self, entity_type, entity_id, page_size, page, **kwargs):  # noqa: E501
        ...
        :param str text_search: The case insensitive 'startsWith' filter based on of next alarm fields: type, severity or status
    ...
    def get_alarms_using_get_with_http_info(self, entity_type, entity_id, page_size, page, **kwargs):  # noqa: E501
        ...
        all_params = ['entity_type', 'entity_id', 'page_size', 'page', 'search_status', 'status', 'text_search',
        ...
        return self.api_client.call_api(
            '/api/alarm/{entityType}/{entityId}{?endTime,fetchOriginator,page,pageSize,searchStatus,sortOrder,sortProperty,startTime,status,textSearch}',
            'GET',
            path_params,
            query_params,
            header_params,
    ...
    def get_all_alarms_using_get_with_http_info(self, page_size, page, **kwargs):  # noqa: E501
        ...
        all_params = ['page_size', 'page', 'search_status', 'status', 'text_search', 'sort_property', 'sort_order',
                      'start_time', 'end_time', 'fetch_originator']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('page_size' not in params or
                params['page_size'] is None):
            raise ValueError(
                "Missing the required parameter `page_size` when calling `get_all_alarms_using_get`")  # noqa: E501
        # verify the required parameter 'page' is set
        if ('page' not in params or
                params['page'] is None):
            raise ValueError(
                "Missing the required parameter `page` when calling `get_all_alarms_using_get`")  # noqa: E501
