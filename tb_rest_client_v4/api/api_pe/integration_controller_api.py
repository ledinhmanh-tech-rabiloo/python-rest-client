...
class IntegrationControllerApi(object):
    ...
    def assign_integration_to_edge_using_post(self, edge_id, integration_id, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.assign_integration_to_edge_using_post_with_http_info(edge_id, integration_id,
                                                                             **kwargs)  # noqa: E501
        else:
            (data) = self.assign_integration_to_edge_using_post_with_http_info(edge_id, integration_id,
                                                                               **kwargs)  # noqa: E501
            return data
    ...
    def assign_integration_to_edge_using_post_with_http_info(self, edge_id, integration_id, **kwargs):  # noqa: E501
        ...
        if ('edge_id' not in params or
                params['edge_id'] is None):
            raise ValueError(
                "Missing the required parameter `edge_id` when calling `assign_integration_to_edge_using_post`")  # noqa: E501
        # verify the required parameter 'integration_id' is set
        if ('integration_id' not in params or
                params['integration_id'] is None):
            raise ValueError(
                "Missing the required parameter `integration_id` when calling `assign_integration_to_edge_using_post`")  # noqa: E501
    ...
    def unassign_integration_from_edge_using_delete(self, edge_id, integration_id, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.unassign_integration_from_edge_using_delete_with_http_info(edge_id, integration_id,
                                                                                   **kwargs)  # noqa: E501
        else:
            (data) = self.unassign_integration_from_edge_using_delete_with_http_info(edge_id, integration_id,
                                                                                     **kwargs)  # noqa: E501
            return data

    def unassign_integration_from_edge_using_delete_with_http_info(self, edge_id, integration_id,
                                                                   **kwargs):  # noqa: E501
        """Unassign integration from edge (unassignIntegrationFromEdge)  # noqa: E501
        ...
        if ('edge_id' not in params or
                params['edge_id'] is None):
            raise ValueError(
                "Missing the required parameter `edge_id` when calling `unassign_integration_from_edge_using_delete`")  # noqa: E501
        # verify the required parameter 'integration_id' is set
        if ('integration_id' not in params or
                params['integration_id'] is None):
            raise ValueError(
                "Missing the required parameter `integration_id` when calling `unassign_integration_from_edge_using_delete`")  # noqa: E501
    ...
    def get_edge_integrations_using_get(self, edge_id, page_size, page, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_edge_integrations_using_get_with_http_info(edge_id, page_size, page,
                                                                         **kwargs)  # noqa: E501
            return data
    ...
    def get_edge_integrations_using_get_with_http_info(self, edge_id, page_size, page, **kwargs):  # noqa: E501
        ...
        if ('edge_id' not in params or
                params['edge_id'] is None):
            raise ValueError(
                "Missing the required parameter `edge_id` when calling `get_edge_integrations_using_get`")  # noqa: E501
        # verify the required parameter 'page_size' is set
        if ('page_size' not in params or
                params['page_size'] is None):
            raise ValueError(
                "Missing the required parameter `page_size` when calling `get_edge_integrations_using_get`")  # noqa: E501
        # verify the required parameter 'page' is set
        if ('page' not in params or
                params['page'] is None):
            raise ValueError(
                "Missing the required parameter `page` when calling `get_edge_integrations_using_get`")  # noqa: E501
    ...
    def find_all_related_edges_missing_attributes_using_get(self, integration_id, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.find_all_related_edges_missing_attributes_using_get_with_http_info(integration_id,
                                                                                           **kwargs)  # noqa: E501
        else:
            (data) = self.find_all_related_edges_missing_attributes_using_get_with_http_info(integration_id,
                                                                                             **kwargs)  # noqa: E501
            return data

    def find_all_related_edges_missing_attributes_using_get_with_http_info(self, integration_id,
                                                                           **kwargs):  # noqa: E501
        """Find missing attributes for all related edges (findAllRelatedEdgesMissingAttributes)  # noqa: E501
        ...
        if ('integration_id' not in params or
                params['integration_id'] is None):
            raise ValueError(
                "Missing the required parameter `integration_id` when calling `find_all_related_edges_missing_attributes_using_get`")  # noqa: E501
    ...
    def get_integrations_using_get_with_http_info(self, page_size, page, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/integrations{?page,pageSize,sortOrder,sortProperty,textSearch}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
