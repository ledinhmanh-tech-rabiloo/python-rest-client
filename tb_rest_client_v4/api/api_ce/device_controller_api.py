...
class DeviceControllerApi(object):
    ...
    def get_customer_device_infos_using_get_with_http_info(self, customer_id, page_size, page, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/customer/{customerId}/deviceInfos{?deviceProfileId,page,pageSize,sortOrder,sortProperty,textSearch,type}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_edge_devices_using_get_with_http_info(self, edge_id, page_size, page, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/edge/{edgeId}/devices{?endTime,page,pageSize,sortOrder,sortProperty,startTime,textSearch,type}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_tenant_device_infos_using_get_with_http_info(self, page_size, page, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/tenant/deviceInfos{?deviceProfileId,page,pageSize,sortOrder,sortProperty,textSearch,type}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
