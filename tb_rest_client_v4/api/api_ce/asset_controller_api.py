...
class AssetControllerApi(object):
    ...
    def assign_asset_to_edge_using_post_with_http_info(self, edge_id, asset_id, **kwargs):  # noqa: E501
        ...
        if ('edge_id' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `edge_id` when calling `assign_asset_to_edge_using_post`")  # noqa: E501
        # verify the required parameter 'asset_id' is set
        if ('asset_id' not in params or
                params['asset_id'] is None):
            raise ValueError(
                "Missing the required parameter `asset_id` when calling `assign_asset_to_edge_using_post`")  # noqa: E501
    ...
    def get_customer_asset_infos_using_get(self, customer_id, page_size, page, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_customer_asset_infos_using_get_with_http_info(customer_id, page_size, page,
                                                                          **kwargs)  # noqa: E501
        else:
            (data) = self.get_customer_asset_infos_using_get_with_http_info(customer_id, page_size, page,
                                                                            **kwargs)  # noqa: E501
            return data
    ...
    def get_customer_asset_infos_using_get_with_http_info(self, customer_id, page_size, page, **kwargs):  # noqa: E501
        ...
        all_params = ['customer_id', 'page_size', 'page', 'type', 'text_search', 'sort_property',
        ...
        if ('page_size' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `page_size` when calling `get_customer_asset_infos_using_get`")  # noqa: E501
        # verify the required parameter 'page' is set
        if ('page' not in params or
                params['page'] is None):
            raise ValueError(
                "Missing the required parameter `page` when calling `get_customer_asset_infos_using_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/customer/{customerId}/assetInfos{?page,pageSize,sortOrder,sortProperty,textSearch,type}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_edge_assets_using_get_with_http_info(self, edge_id, page_size, page, **kwargs):  # noqa: E501
        ...
        all_params = ['edge_id', 'page_size', 'page', 'type', 'text_search', 'sort_property', 'sort_order',
    ...
    def get_tenant_asset_infos_using_get_with_http_info(self, page_size, page, **kwargs):  # noqa: E501
        ...
        if ('page_size' not in params or
                params['page_size'] is None):
            raise ValueError(
                "Missing the required parameter `page_size` when calling `get_tenant_asset_infos_using_get`")  # noqa: E501
        # verify the required parameter 'page' is set
        if ('page' not in params or
                params['page'] is None):
            raise ValueError(
                "Missing the required parameter `page` when calling `get_tenant_asset_infos_using_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/tenant/assetInfos{?page,pageSize,sortOrder,sortProperty,textSearch,type}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def unassign_asset_from_edge_using_delete_with_http_info(self, edge_id, asset_id, **kwargs):  # noqa: E501
        ...
        if ('asset_id' not in params or
                params['asset_id'] is None):
            raise ValueError(
                "Missing the required parameter `asset_id` when calling `unassign_asset_from_edge_using_delete`")  # noqa: E501
