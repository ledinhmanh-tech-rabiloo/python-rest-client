...
from tb_rest_client_v4.api_client import ApiClient
    ...
    def __init__(self, id=None, created_time=None, tenant_id=None, customer_id=None, owner_id=None, name=None, type=None, schedule=None, additional_info=None):  # noqa: E501
