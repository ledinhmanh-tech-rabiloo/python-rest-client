...
from tb_rest_client_v4.api_client import ApiClient
    ...
    def __init__(self, external_id=None, id=None, created_time=None, tenant_id=None, customer_id=None, owner_id=None, name=None, type=None, label=None, device_profile_id=None, device_data=None, firmware_id=None, software_id=None, additional_info=None):  # noqa: E501
