...
from tb_rest_client_v4.api_client import ApiClient
    ...
    def __init__(self, id=None, created_time=None, tenant_id=None, bundle_alias=None, alias=None, name=None, descriptor=None, image=None, description=None):  # noqa: E501
