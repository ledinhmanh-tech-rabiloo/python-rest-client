...
from tb_rest_client_v4.api_client import ApiClient
    ...
    def __init__(self, rule_chains=None, metadata=None):  # noqa: E501
    ...
    def rule_chains(self):
        ...
        List of the Rule Chain objects.  # noqa: E501
    ...
    def rule_chains(self, rule_chains):
        ...
        :type: list[RuleChain]
        """
        if rule_chains is None:
            raise ValueError("Invalid value for `rule_chains`, must not be `None`")  # noqa: E501
    ...
    def metadata(self):
        ...
        List of the Rule Chain metadata objects.  # noqa: E501
