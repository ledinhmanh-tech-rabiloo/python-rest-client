...
from tb_rest_client_v4.api_client import ApiClient
    ...
    def __init__(self, external_id=None, id=None, created_time=None, tenant_id=None, customer_id=None, name=None, type=None, label=None, additional_info=None):  # noqa: E501
