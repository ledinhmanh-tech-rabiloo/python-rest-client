...
from tb_rest_client_v4.api_client import ApiClient
    ...
    def type(self, type):
        ...
        :type: str
        """
        allowed_values = ["ADMIN_SETTINGS", "ALARM", "ASSET", "CUSTOMER", "DASHBOARD", "DEVICE", "DEVICE_PROFILE", "EDGE", "ENTITY_VIEW", "OTA_PACKAGE", "QUEUE", "RELATION", "RULE_CHAIN", "RULE_CHAIN_METADATA", "TENANT", "USER", "WIDGETS_BUNDLE", "WIDGET_TYPE"]  # noqa: E501
