...
class X509LwM2MBootstrapServerCredential(object):
...
from tb_rest_client_v4.api_client import ApiClient
    ...
    def __init__(self, short_server_id=None, bootstrap_server_is=None, host=None, port=None, client_hold_off_time=None, server_public_key=None, server_certificate=None, bootstrap_server_account_timeout=None, lifetime=None, default_min_period=None, notif_if_disabled=None, binding=None):  # noqa: E501
        """X509LwM2MBootstrapServerCredential - a model defined in Swagger"""  # noqa: E501
    ...
    def short_server_id(self):
        """Gets the short_server_id of this X509LwM2MBootstrapServerCredential.  # noqa: E501
        ...
        :return: The short_server_id of this X509LwM2MBootstrapServerCredential.  # noqa: E501
        :rtype: int
        """
    ...
    def short_server_id(self, short_server_id):
        """Sets the short_server_id of this X509LwM2MBootstrapServerCredential.

        Server short Id. Used as link to associate server Object Instance. This identifier uniquely identifies each LwM2M Server configured for the LwM2M Client. This Resource MUST be set when the Bootstrap-Server Resource has a value of 'false'. The values ID:0 and ID:65535 values MUST NOT be used for identifying the LwM2M Server.  # noqa: E501

        :param short_server_id: The short_server_id of this X509LwM2MBootstrapServerCredential.  # noqa: E501
        :type: int
        """
    ...
    def bootstrap_server_is(self):
        """Gets the bootstrap_server_is of this X509LwM2MBootstrapServerCredential.  # noqa: E501
        ...
        :return: The bootstrap_server_is of this X509LwM2MBootstrapServerCredential.  # noqa: E501
        :rtype: bool
        """
    ...
    def bootstrap_server_is(self, bootstrap_server_is):
        """Sets the bootstrap_server_is of this X509LwM2MBootstrapServerCredential.

        Is Bootstrap Server or Lwm2m Server. The LwM2M Client MAY be configured to use one or more LwM2M Server Account(s). The LwM2M Client MUST have at most one LwM2M Bootstrap-Server Account. (*) The LwM2M client MUST have at least one LwM2M server account after completing the boot sequence specified.  # noqa: E501

        :param bootstrap_server_is: The bootstrap_server_is of this X509LwM2MBootstrapServerCredential.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def host(self):
        """Gets the host of this X509LwM2MBootstrapServerCredential.  # noqa: E501

        Host for 'No Security' mode  # noqa: E501

        :return: The host of this X509LwM2MBootstrapServerCredential.  # noqa: E501
        :rtype: str
        """
        return self._host
    ...
    @host.setter
    def host(self, host):
        """Sets the host of this X509LwM2MBootstrapServerCredential.

        Host for 'No Security' mode  # noqa: E501

        :param host: The host of this X509LwM2MBootstrapServerCredential.  # noqa: E501
        :type: str
        """
    ...
    @property
    def port(self):
        """Gets the port of this X509LwM2MBootstrapServerCredential.  # noqa: E501

        Port for  Lwm2m Server: 'No Security' mode: Lwm2m Server or Bootstrap Server  # noqa: E501

        :return: The port of this X509LwM2MBootstrapServerCredential.  # noqa: E501
        :rtype: int
        """
        return self._port
    ...
    @port.setter
    def port(self, port):
        """Sets the port of this X509LwM2MBootstrapServerCredential.

        Port for  Lwm2m Server: 'No Security' mode: Lwm2m Server or Bootstrap Server  # noqa: E501

        :param port: The port of this X509LwM2MBootstrapServerCredential.  # noqa: E501
        :type: int
        """
    ...
    def client_hold_off_time(self):
        """Gets the client_hold_off_time of this X509LwM2MBootstrapServerCredential.  # noqa: E501
        ...
        :return: The client_hold_off_time of this X509LwM2MBootstrapServerCredential.  # noqa: E501
        :rtype: int
        """
    ...
    def client_hold_off_time(self, client_hold_off_time):
        """Sets the client_hold_off_time of this X509LwM2MBootstrapServerCredential.

        Client Hold Off Time. The number of seconds to wait before initiating a Client Initiated Bootstrap once the LwM2M Client has determined it should initiate this bootstrap mode. (This information is relevant for use with a Bootstrap-Server only.)  # noqa: E501

        :param client_hold_off_time: The client_hold_off_time of this X509LwM2MBootstrapServerCredential.  # noqa: E501
        :type: int
        """
    ...
    def server_public_key(self):
        """Gets the server_public_key of this X509LwM2MBootstrapServerCredential.  # noqa: E501

        Server Public Key for 'Security' mode (DTLS): RPK or X509. Format: base64 encoded  # noqa: E501

        :return: The server_public_key of this X509LwM2MBootstrapServerCredential.  # noqa: E501
        :rtype: str
        """
    ...
    def server_public_key(self, server_public_key):
        """Sets the server_public_key of this X509LwM2MBootstrapServerCredential.

        Server Public Key for 'Security' mode (DTLS): RPK or X509. Format: base64 encoded  # noqa: E501

        :param server_public_key: The server_public_key of this X509LwM2MBootstrapServerCredential.  # noqa: E501
        :type: str
        """
    ...
    def server_certificate(self):
        """Gets the server_certificate of this X509LwM2MBootstrapServerCredential.  # noqa: E501

        Server Public Key for 'Security' mode (DTLS): X509. Format: base64 encoded  # noqa: E501

        :return: The server_certificate of this X509LwM2MBootstrapServerCredential.  # noqa: E501
        :rtype: str
        """
    ...
    def server_certificate(self, server_certificate):
        """Sets the server_certificate of this X509LwM2MBootstrapServerCredential.

        Server Public Key for 'Security' mode (DTLS): X509. Format: base64 encoded  # noqa: E501

        :param server_certificate: The server_certificate of this X509LwM2MBootstrapServerCredential.  # noqa: E501
        :type: str
        """
    ...
    def bootstrap_server_account_timeout(self):
        """Gets the bootstrap_server_account_timeout of this X509LwM2MBootstrapServerCredential.  # noqa: E501
        ...
        :return: The bootstrap_server_account_timeout of this X509LwM2MBootstrapServerCredential.  # noqa: E501
        :rtype: int
        """
    ...
    def bootstrap_server_account_timeout(self, bootstrap_server_account_timeout):
        """Sets the bootstrap_server_account_timeout of this X509LwM2MBootstrapServerCredential.

        Bootstrap Server Account Timeout (If the value is set to 0, or if this resource is not instantiated, the Bootstrap-Server Account lifetime is infinite.)  # noqa: E501

        :param bootstrap_server_account_timeout: The bootstrap_server_account_timeout of this X509LwM2MBootstrapServerCredential.  # noqa: E501
        :type: int
        """
    ...
    @property
    def lifetime(self):
        """Gets the lifetime of this X509LwM2MBootstrapServerCredential.  # noqa: E501

        Specify the lifetime of the registration in seconds.  # noqa: E501

        :return: The lifetime of this X509LwM2MBootstrapServerCredential.  # noqa: E501
        :rtype: int
        """
    ...
    def lifetime(self, lifetime):
        """Sets the lifetime of this X509LwM2MBootstrapServerCredential.

        Specify the lifetime of the registration in seconds.  # noqa: E501

        :param lifetime: The lifetime of this X509LwM2MBootstrapServerCredential.  # noqa: E501
        :type: int
        """
    ...
    def default_min_period(self):
        """Gets the default_min_period of this X509LwM2MBootstrapServerCredential.  # noqa: E501
        ...
        :return: The default_min_period of this X509LwM2MBootstrapServerCredential.  # noqa: E501
        :rtype: int
        """
    ...
    def default_min_period(self, default_min_period):
        """Sets the default_min_period of this X509LwM2MBootstrapServerCredential.

        The default value the LwM2M Client should use for the Minimum Period of an Observation in the absence of this parameter being included in an Observation. If this Resource doesn’t exist, the default value is 0.  # noqa: E501

        :param default_min_period: The default_min_period of this X509LwM2MBootstrapServerCredential.  # noqa: E501
        :type: int
        """
    ...
    def notif_if_disabled(self):
        """Gets the notif_if_disabled of this X509LwM2MBootstrapServerCredential.  # noqa: E501
        ...
        :return: The notif_if_disabled of this X509LwM2MBootstrapServerCredential.  # noqa: E501
        :rtype: bool
        """
    ...
    def notif_if_disabled(self, notif_if_disabled):
        """Sets the notif_if_disabled of this X509LwM2MBootstrapServerCredential.

        If true, the LwM2M Client stores “Notify” operations to the LwM2M Server while the LwM2M Server account is disabled or the LwM2M Client is offline. After the LwM2M Server account is enabled or the LwM2M Client is online, the LwM2M Client reports the stored “Notify” operations to the Server. If false, the LwM2M Client discards all the “Notify” operations or temporarily disables the Observe function while the LwM2M Server is disabled or the LwM2M Client is offline. The default value is true.  # noqa: E501

        :param notif_if_disabled: The notif_if_disabled of this X509LwM2MBootstrapServerCredential.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def binding(self):
        """Gets the binding of this X509LwM2MBootstrapServerCredential.  # noqa: E501
        ...
        :return: The binding of this X509LwM2MBootstrapServerCredential.  # noqa: E501
        :rtype: str
        """
    ...
    def binding(self, binding):
        """Sets the binding of this X509LwM2MBootstrapServerCredential.

        This Resource defines the transport binding configured for the LwM2M Client. If the LwM2M Client supports the binding specified in this Resource, the LwM2M Client MUST use that transport for the Current Binding Mode.  # noqa: E501

        :param binding: The binding of this X509LwM2MBootstrapServerCredential.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(X509LwM2MBootstrapServerCredential, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, X509LwM2MBootstrapServerCredential):
            return False
