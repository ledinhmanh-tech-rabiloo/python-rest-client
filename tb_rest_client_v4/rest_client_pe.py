...
class RestClientPE(RestClientBase):
    ...
    def change_owner_to_customer(self, owner_id: UserId, entity_id: EntityId) -> None:
    ...
    def change_owner_to_tenant(self, owner_id: UserId, entity_id: EntityId) -> None:
        owner_id = self.get_id(owner_id)
        entity_type = self.get_type(entity_id)
        entity_id = self.get_id(entity_id)
    ...
    def get_entity_groups_by_type(self, group_type: str) -> List[EntityGroupInfo]:
